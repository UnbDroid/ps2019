...
def funcionarios():
    ...
    print(" ")
    print(" ")
    print("Cargo: Diretora de Lancamento")
    ...
    print("\t\tInformacoes Complementares: Especialista em programacao, paciente e atenciosa.")
    print(" ")
    print(" ")
    print("Cargo: Diretor de Seguranca")
    ...
    print("\t\tInformacoes Complementares: Especialista em hardware e focado em defender os interesses da empresa")
    print(" ")
    print(" ")
    print("Cargo: Estagiario")
    print("\t\tNome completo: Giordano Melo Gois")
    print("\t\tIdade: 24 anos")
    print("\t\tEstado civil: Casado")
    print("\t\tNacionalidade: Brasileiro")
    print("\t\tTempo dentro da empresa: 1 ano")
    print("\t\tFormacao: Engenheiro de Controle e Automacao")
    print("\t\tInformacoes Complementares: Excelente programador, resolvedor de problemas e fissurado por LEDs")
    print(" ")
    print(" ")
    print("Cargo: Diretora de Tecnologia")
    ...
    print("\t\tInformacoes Complementares: Especialista em programacao e em relacoes publicas")
    print(" ")
    print(" ")
    print("Cargo: Diretora de Engenharia")
    ...
    print("\t\tTempo dentro da empresa: 5 anos")
    print("\t\tFormacao: Engenharia de Controle e Automacao")
    print("\t\tInformacoes Complementares: Especialista em hardware e extremamente critica")
    print(" ")
    print(" ")
    print("Cargo: Estagiario")
    ...
    print("\t\tInformacoes Complementares: Especialista em eletronica e extremamente atencioso com os colegas de trabalho")
    print(" ")
    print(" ")
