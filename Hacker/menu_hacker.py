...
def funcionarios():
    ...
    print(" ")
    print(" ")
    print("Area: Diretoria de planejamento, orçamento e administracao")
    ...
    print(" ")
    print(" ")
    print("Area: Diretoria de politica espacial e investimentos estrategicos")
    ...
    print(" ")
    print(" ")
    print("Area: Diretoria de Satelites, aplicacoes e desenvolvimento")
    ...
    print(" ")
    print(" ")
    print("Area: Diretoria de transporte espacial e licenciamento")
