        ...
        if arduinoSerial.inWaiting() > 0:
            ...
            if '3' in Station_name:
                ...
                if read_char == 'p' :
                    ...
                    if read_char != 't':
                        #print("Communication error! Expecting t identifier")
                        arduinoSerial.flush()
                        arduinoSerial.write('o')
                        pass
...
def play_time(start_room, end_room):
    ...
    # Show for more 3 minutes, dumb way to synchronize 2 stations
    time_passed = 0
    if ret == True:
        while time_passed < 180000:
